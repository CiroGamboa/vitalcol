"""
Django settings for vitalcol project.
...
SECRET_KEY = '6wl4k#-zkp#(()=i&_w=l%s=_0g1(o!-47qs-9v2-2f5oj(z-('
...
WSGI_APPLICATION = 'vitalcol.wsgi.application'
